...
declare function local:wrap(){
        util:declare-option("exist:serialize","method=text media-type=text/plain indent=yes")  ,  local:main()
};

util:declare-option("exist:serialize","method=text media-type=text/plain indent=yes")  , transform:transform(local:main(), doc("finish.xsl"), ())
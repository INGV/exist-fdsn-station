...
let $fixed:=stationutil:rewrite_collections_change_dates()
let $log:=util:log("info","collection fixed")
...
<div xmlns="http://www.w3.org/1999/xhtml" data-template="templates:surround" data-template-with="templates/page.html" data-template-at="content">
        <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h1>Dates in collections fixed</h1>
                </div>
            </div>
        </div>
        <div class="col-md-3">
...
<div xmlns="http://www.w3.org/1999/xhtml" data-template="templates:surround" data-template-with="templates/page.html" data-template-at="content">
        <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h1>Error fixing dates in collection</h1>
                </div>
            </div>
        </div>
        <div class="col-md-3">

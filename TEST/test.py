...
("minlat=31&format=xml&maxlat=51&start=2019-01-02&minlon=6&maxlon=38&level=station&station=A*A",200,
'<FDSNStationXML xmlns:ingv="https://raw.githubusercontent.com/FDSN/StationXML/master/fdsn-station.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.fdsn.org/xml/station/1" schemaVersion="1.2" xsi:schemaLocation="http://www.fdsn.org/xml/station/1 http://www.fdsn.org/xml/station/fdsn-station-1.2.xsd"><Source>eXistDB</Source><Sender>INGV-ONT</Sender><Module>INGV-ONT WEB SERVICE: fdsnws-station | version: 1.1.62</Module><ModuleURI>/exist/apps/fdsn-station/fdsnws/station/1/query?minlat=31&amp;format=xml&amp;maxlat=51&amp;start=2019-01-02&amp;minlon=6&amp;maxlon=38&amp;level=station&amp;station=A*A</ModuleURI><Created>2025-06-27T13:08:38.633</Created><Network code="TH" startDate="1980-01-01T00:00:00" alternateCode="Test alternate code" historicalCode="Test historical code" sourceID="http://test.exist.fdsn.station/xml/station/1234" restrictedStatus="partial"><Description>Thuringia Seismic Network, Uni Jena</Description><Identifier type="DOI">10.7914/SN/TH</Identifier><TotalNumberStations>4</TotalNumberStations><SelectedNumberStations>1</SelectedNumberStations><Station code="ANNA" startDate="2017-12-04T00:00:00" restrictedStatus="open"><Latitude>50.88902</Latitude><Longitude>12.64499</Longitude><Elevation>235</Elevation><Site><Name>UJENA Station St. Anna Fundgrube, Germany</Name><Country>Germany</Country></Site><CreationDate>2017-12-04T00:00:00</CreationDate></Station></Network><Network code="Z3" startDate="2015-01-01T00:00:00" endDate="2022-12-31T00:00:00" restrictedStatus="closed"><Description>AlpArray Seismic Network (AASN) temporary component</Description><Identifier type="DOI">10.12686/alparray/z3_2015</Identifier><ingv:Identifier>N81</ingv:Identifier><TotalNumberStations>1</TotalNumberStations><SelectedNumberStations>1</SelectedNumberStations><Station code="A319A" startDate="2015-12-11T12:06:34" endDate="2019-04-10T23:59:00" restrictedStatus="closed"><ingv:Identifier>S3331</ingv:Identifier><Latitude>43.476425</Latitude><Longitude>10.578689</Longitude><Elevation>343</Elevation><Site><Name>Santa Luce (PI)</Name></Site><CreationDate>2015-12-11T12:06:34</CreationDate><TerminationDate>2019-04-11T23:59:00</TerminationDate></Station></Network></FDSNStationXML>',"Looking up in netcache for station level")
...
S|ELFMC|47.3855|8.5996|650|Gockhausen, Lycee Francais de Marie Curie, ZH|2010-05-11T00:00:00|2015-07-01T00:01:54.843\n\
SI|ABSI|46.7285|11.3205|1801|Aberstuckl (Sarntal)|2006-11-21T14:16:45|\n\
TH|ABG1|50.96532|12.57208|203|UJENA Station Forsthaus Leinawald, Germany|2011-10-18T16:00:00|2012-11-22T12:00:00\n\
TH|ABG1|50.96757|12.57625|203|UJENA Station Forsthaus Leinawald, Germany|2012-11-22T12:00:00|\n\
TH|ANNA|50.88399|12.64365|249|UJENA Station St. Anna Fundgrube, Germany|2014-03-25T10:00:00|2017-12-04T00:00:00\n\
TH|ANNA|50.88902|12.64499|235|UJENA Station St. Anna Fundgrube, Germany|2017-12-04T00:00:00|\n\
TV|AT04|43.254269|12.450467|595|Castiglione Aldobrando|2010-03-31T00:00:00|2011-02-09T09:55:00\n\
Z3|AT04|37.7252|24.0496|23|Station Egelados Network, Greece|2005-11-02T00:00:00|2007-02-23T00:00:00\n\
...
# "", "INGV_A319A.xml", "TEST/data/Station/", 200,
# '',
# "PUT_LOCK_CACHE", "PUT A319A station again [NetCache] with lock"),
...
(
"","INGV_NUOVA.xml","TEST/data/Fake/",409,
'',
"PUT" , "PUT NUOVA station, fail for conflicting network"),
...
"", "INGV_ACER.xml", "TEST/data/Station/", 200,
'',
"PUT_LOCK_CACHE", "PUT ACER station again [NetCache] with lock"),
]
...
def test_io(query,name,path,expected_status_code,expected_content,action,comment,host):
    ...
    if action == 'PUT_LOCK_CACHE':
        print("Inserting: " + name + " in " + webservicepath + " with lock")
        response = requests.put(url=webservicepath, data=open(filename, 'rb'), headers={"Content-Type": "application/octet-stream", "filename": name, "lockseconds": "1"}, auth=HTTPBasicAuth('fdsn', 'fdsn'))
    elif action == 'DELETE':
